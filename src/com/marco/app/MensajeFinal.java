...
public class MensajeFinal {
    ...
    ImageIcon iconP = new ImageIcon(getClass().getResource("/com/marco/icons/icon-question.png"));
    ImageIcon iconE = new ImageIcon(getClass().getResource("/com/marco/icons/icon-salir.png"));
